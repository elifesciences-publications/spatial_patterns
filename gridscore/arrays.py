...
def get_maximapositions_maximavalues(x, y, neighborhood_size_as_fraction,
	...
	threshold_difference_as_fraction : float in [0, 1]
	...
	neighborhood_size = neighborhood_size_as_fraction * len(y)
